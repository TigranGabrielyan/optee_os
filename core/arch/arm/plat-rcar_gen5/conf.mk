...
# Increase heap size to 128KB (originally 64KB) to avoid this issue.
# 80KB and 96KB heap size was tried as well. Even if the hang issue during Dom0 boot is not observed,
# several tests are still failing when xtest is executed in DomD/DomU.
